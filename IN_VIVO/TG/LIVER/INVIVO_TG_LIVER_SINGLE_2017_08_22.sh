...
Rscript ~/gitProjects/WGCNA/1_readCEL_runRMA.R /data/wouter/WGCNA/OUTPUT/IN_VIVO/TG/LIVER/SINGLE/ rat2302rnentrezgcdf /data/wouter/WGCNA/OUTPUT/IN_VIVO/TG/LIVER/SINGLE/